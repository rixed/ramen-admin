...
TimeRangeEdit::TimeRangeEdit(QWidget *parent)
  ...
  connect(this, &QPushButton::clicked, this, &TimeRangeEdit::wantOpen);
  ...
  connect(buttonBox, &QDialogButtonBox::clicked, this,
          &TimeRangeEdit::wantSubmit);
  connect(buttonBox, &QDialogButtonBox::rejected, this,
          &TimeRangeEdit::wantCancel);

  /* When the user toggle the radio button to select which time selector
   * is meant to be used, then disable the other one: */
  connect(selectLastSeconds, &QRadioButton::toggled, this,
          &TimeRangeEdit::updateEnabled);
}
...
void TimeRangeEdit::wantOpen() {
  if (verbose) qDebug() << "TimeRangeEdit::wantOpen()";
...
void TimeRangeEdit::wantCancel() {
  if (verbose) qDebug() << "TimeRangeEdit::wantCancel()";
