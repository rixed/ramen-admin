...
extern std::function<::dessser::gen::sync_selector::ta30293a82943182cab78182f33b18016(Pointer)> of_row_binary;
extern std::function<::dessser::gen::sync_selector::ta30293a82943182cab78182f33b18016(Pointer)> wrap_of_row_binary;
