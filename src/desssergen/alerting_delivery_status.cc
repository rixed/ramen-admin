...
{
  std::function<f63f919559f0d70225bd0da5dd9bcafc(Pointer)> fun59 { [&fun59](Pointer p_0) {
    v_362f9d9108a6902af48b6c83d5377ea1 id_60 { p_0.readU16Le() };
    v_362f9d9108a6902af48b6c83d5377ea1 letpair_res_61;
    {
      auto du16_fst_57 { std::get<0>(id_60) };
      auto du16_snd_58 { std::get<1>(id_60) };
      v_362f9d9108a6902af48b6c83d5377ea1 id_62 {  du16_fst_57, du16_snd_58  };
      letpair_res_61 = id_62;
    }
    f63f919559f0d70225bd0da5dd9bcafc let_res_63;
    {
      v_362f9d9108a6902af48b6c83d5377ea1 dsum1_62 { letpair_res_61 };
      f63f919559f0d70225bd0da5dd9bcafc letpair_res_64;
      {
        auto dsum1_fst_63 { std::get<0>(dsum1_62) };
        auto dsum1_snd_64 { std::get<1>(dsum1_62) };
        uint16_t id_65 { 0 };
        bool id_66 { bool(id_65 == dsum1_fst_63) };
        f63f919559f0d70225bd0da5dd9bcafc choose_res_67;
        if (id_66) {
          t id_68 { std::in_place_index<0>, VOID };
          f63f919559f0d70225bd0da5dd9bcafc id_69 {  id_68, dsum1_snd_64  };
          choose_res_67 = id_69;
        } else {
          uint16_t id_70 { 1 };
          bool id_71 { bool(id_70 == dsum1_fst_63) };
          f63f919559f0d70225bd0da5dd9bcafc choose_res_72;
          if (id_71) {
            t id_73 { std::in_place_index<1>, VOID };
            f63f919559f0d70225bd0da5dd9bcafc id_74 {  id_73, dsum1_snd_64  };
            choose_res_72 = id_74;
          } else {
            uint16_t id_75 { 2 };
            bool id_76 { bool(id_75 == dsum1_fst_63) };
            f63f919559f0d70225bd0da5dd9bcafc choose_res_77;
            if (id_76) {
              t id_78 { std::in_place_index<2>, VOID };
              f63f919559f0d70225bd0da5dd9bcafc id_79 {  id_78, dsum1_snd_64  };
              choose_res_77 = id_79;
            } else {
              uint16_t id_80 { 3 };
              bool id_81 { bool(id_80 == dsum1_fst_63) };
              f63f919559f0d70225bd0da5dd9bcafc choose_res_82;
              if (id_81) {
                t id_83 { std::in_place_index<3>, VOID };
                f63f919559f0d70225bd0da5dd9bcafc id_84 {  id_83, dsum1_snd_64  };
                choose_res_82 = id_84;
              } else {
                uint16_t id_85 { 4 };
                bool id_86 { bool(id_85 == dsum1_fst_63) };
                f63f919559f0d70225bd0da5dd9bcafc choose_res_87;
                if (id_86) {
                  t id_88 { std::in_place_index<4>, VOID };
                  f63f919559f0d70225bd0da5dd9bcafc id_89 {  id_88, dsum1_snd_64  };
                  choose_res_87 = id_89;
                } else {
                  uint16_t id_90 { 5 };
                  bool id_91 { bool(dsum1_fst_63 == id_90) };
                  Void id_92 { ((void)(assert(id_91)), VOID) };
                  t id_93 { std::in_place_index<5>, VOID };
                  f63f919559f0d70225bd0da5dd9bcafc id_94 {  id_93, dsum1_snd_64  };
                  choose_res_87 = id_94;
                }
    ...
    f63f919559f0d70225bd0da5dd9bcafc letpair_res_95;
    {
      auto make_fst_84 { std::get<0>(let_res_63) };
      auto make_snd_85 { std::get<1>(let_res_63) };
      f63f919559f0d70225bd0da5dd9bcafc id_96 {  make_fst_84, make_snd_85  };
