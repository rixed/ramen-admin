...
inline bool operator==(t7a1727acfeac88acd54a67e8464ac4df const &a, t7a1727acfeac88acd54a67e8464ac4df const &b) {
  return std::get<0>(a) == std::get<0>(b) && std::get<1>(a) == std::get<1>(b);
}
inline bool operator!=(t7a1727acfeac88acd54a67e8464ac4df const &a, t7a1727acfeac88acd54a67e8464ac4df const &b) {
  return !operator==(a, b);
...
inline bool operator==(t198be7bbfe6ba2c2ebb0d66b38cfb5fd const &a, t198be7bbfe6ba2c2ebb0d66b38cfb5fd const &b) {
  return std::get<0>(a) == std::get<0>(b) && std::get<1>(a) == std::get<1>(b);
}
inline bool operator!=(t198be7bbfe6ba2c2ebb0d66b38cfb5fd const &a, t198be7bbfe6ba2c2ebb0d66b38cfb5fd const &b) {
  return !operator==(a, b);
  ...
  std::function<::dessser::gen::alerting_contact::t64d64e9c0acacb981f0a90c22987e81e(Pointer)> fun876 { [&fun876](Pointer p_0) {
    ...
    ::dessser::gen::alerting_contact::t7a1727acfeac88acd54a67e8464ac4df let_res_880;
    {
      ...
      ::dessser::gen::alerting_contact::t7a1727acfeac88acd54a67e8464ac4df letpair_res_881;
      {
        ...
        if (id_883) {
          (void)VOID;
          ::dessser::gen::alerting_contact::ta2737d85243c228c957e6a89b1a2eaef id_885 { std::in_place_index<0>, VOID };
