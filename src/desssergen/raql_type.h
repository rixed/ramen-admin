...
inline std::ostream &operator<<(std::ostream &os, t26bed784ba9fd0d7cece3d88b00d59c3 const &t) {
  os << '<';
  os << std::get<0>(t) << ", ";
  os << std::get<1>(t);
  os << '>';
...
inline std::ostream &operator<<(std::ostream &os, std::shared_ptr<t26bed784ba9fd0d7cece3d88b00d59c3> const t) { os << *t; return os; }
