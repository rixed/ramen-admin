    ...
    Pointer let_res_3;
    {
      ...
      Pointer let_res_5;
      {
        ...
        do {
          ...
          Void id_24 { ((void)(leb128_ptr_75[id_7] = id_23), ::dessser::VOID) };
          (void)id_24;
          uint8_t id_25 { 0 };
          uint8_t id_26 { 0 };
          ...
          Void id_30 { ((void)(leb128_sz_74[id_25] = id_29), ::dessser::VOID) };
          (void)id_30;
          uint8_t id_31 { 0 };
      ...
      Size let_res_45;
      {
        ...
        do {
          ...
          if (while_flag_46) {
            ...
            Void id_59 { ((void)(lebsz_ref_73[id_54] = id_58), ::dessser::VOID) };
            (void)id_59;
          }
        } while (while_flag_46);
        (void)::dessser::VOID;
...
{
  std::function<::dessser::gen::program_name::ta30293a82943182cab78182f33b18016(Pointer)> fun66 { [&fun66](Pointer p_0) {
    uint32_t id_67 { 0U };
      ...
      ::dessser::gen::program_name::t12fb9c475959b52bf7b17b155a955ffa let_res_72;
      {
        ...
        ::dessser::gen::program_name::t12fb9c475959b52bf7b17b155a955ffa let_res_74;
        {
          ...
          do {
            ...
            bool let_res_79;
            {
              ::dessser::gen::program_name::t1a5d74abf838df33f185a72a8912f5c9 leb128_59 { id_78 };
              bool letpair_res_80;
              {
                auto leb128_fst_60 { std::get<0>(leb128_59) };
                auto leb128_snd_61 { std::get<1>(leb128_59) };
                uint8_t id_81 { 0 };
                Void id_82 { ((void)(p_ref_58[id_81] = leb128_snd_61), ::dessser::VOID) };
                (void)id_82;
                uint8_t id_83 { 0 };
                uint8_t id_84 { 127 };
                ...
                Void id_93 { ((void)(leb_ref_56[id_83] = id_92), ::dessser::VOID) };
                (void)id_93;
                uint8_t id_94 { 0 };
                uint8_t id_95 { 0 };
                ...
                Void id_99 { ((void)(shft_ref_57[id_94] = id_98), ::dessser::VOID) };
                (void)id_99;
                uint8_t id_100 { 128 };
    ...
    {
      ::dessser::gen::program_name::t12fb9c475959b52bf7b17b155a955ffa dstring1_62 { let_res_69 };
      ::dessser::gen::program_name::ta30293a82943182cab78182f33b18016 letpair_res_109;
      {
        ...
        ::dessser::gen::program_name::t9ef6882174ae71a34a3c5ef6b29242fb id_110 { dstring1_snd_64.readBytes(dstring1_fst_63) };
        ::dessser::gen::program_name::ta30293a82943182cab78182f33b18016 letpair_res_111;
        {
          ...
          ::dessser::gen::program_name::ta30293a82943182cab78182f33b18016 id_113 { id_112, dstring2_snd_67 };
...
/* 
    (fun ("Ptr") (let-pair "make_fst_69" "make_snd_70" (apply (identifier "of-row-binary") (param 0)) (make-tup (identifier "make_fst_69") (identifier "make_snd_70"))))
 */
static std::function<::dessser::gen::program_name::ta30293a82943182cab78182f33b18016(Pointer)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::program_name::ta30293a82943182cab78182f33b18016(Pointer)> fun114 { [&fun114](Pointer p_0) {
    ...
    {
      auto make_fst_69 { std::get<0>(id_115) };
      auto make_snd_70 { std::get<1>(id_115) };
      ::dessser::gen::program_name::ta30293a82943182cab78182f33b18016 id_117 { make_fst_69, make_snd_70 };
