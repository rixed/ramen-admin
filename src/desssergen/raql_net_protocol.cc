  ...
  std::function<::dessser::gen::raql_net_protocol::t55bea3e51aa79e08de131e8d87a06294(Pointer &)> fun32 { [&](Pointer p_0) {
    ...
    ::dessser::gen::raql_net_protocol::t55bea3e51aa79e08de131e8d87a06294 let_res_36;
    {
      ...
      ::dessser::gen::raql_net_protocol::t55bea3e51aa79e08de131e8d87a06294 letpair_res_37;
      {
        ...
        if (id_39) {
          (void)::dessser::Void();
          ::dessser::gen::raql_net_protocol::t id_41 { std::in_place_index<0>, ::dessser::Void() };
          ...
          if (id_44) {
            (void)::dessser::Void();
            ::dessser::gen::raql_net_protocol::t id_46 { std::in_place_index<1>, ::dessser::Void() };
            ...
            (void)id_50;
            (void)::dessser::Void();
            ::dessser::gen::raql_net_protocol::t id_51 { std::in_place_index<2>, ::dessser::Void() };
