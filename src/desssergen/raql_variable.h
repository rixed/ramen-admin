...
inline std::ostream &operator<<(std::ostream &os, t87038ef54fe257dd167046e75b43b9c5 const &t) {
  os << '<'
     << *std::get<0>(t) << ", "
     << std::get<1>(t)
     << '>';
...
extern std::function<::dessser::gen::raql_variable::t87038ef54fe257dd167046e75b43b9c5(Pointer)> of_row_binary;
typedef t *t_ext;
