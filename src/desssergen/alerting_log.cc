      ...
      ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_501;
      {
        ...
        if (id_503) {
          ...
          ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_530;
          {
            ...
            std::shared_ptr<::dessser::gen::alerting_log::t>  id_531 { std::make_shared<::dessser::gen::alerting_log::t>(std::in_place_index<0>, dsum2_fst_187) };
            ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_532 { id_531, dsum2_snd_188 };
            ...
            ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 let_res_583;
            {
              ...
              ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_584;
              {
                ...
                ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_586;
                {
                  ...
                  ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_589 { id_588, du32_snd_158 };
            ...
            if (id_591) {
              ...
              ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 let_res_634;
              {
                ...
                ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_635;
                {
                  ...
                  ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_637;
                  {
                    ...
                    ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_640 { id_639, dstring2_snd_137 };
              ...
              if (id_642) {
                ...
                ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_756;
                {
                  ...
                  std::shared_ptr<::dessser::gen::alerting_log::t>  id_757 { std::make_shared<::dessser::gen::alerting_log::t>(std::in_place_index<3>, dsum2_fst_124) };
                  ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_758 { id_757, dsum2_snd_125 };
                ...
                ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 let_res_803;
                {
                  ...
                  ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_804;
                  {
                    ...
                    ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_806;
                    {
                      ...
                      ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_809 { id_808, dstring2_snd_77 };
...
static std::function<::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190(Pointer)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190(Pointer)> fun810 { [&](Pointer p_0) {
    ...
    ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 letpair_res_812;
    {
      ...
      ::dessser::gen::alerting_log::te9c1cd78a0ebfca77aef3940bddf8190 id_813 { make_fst_190, make_snd_191 };
