 ...
 */
static std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> fun0 { [&](::dessser::gen::raql_ip_protocol::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> to_row_binary(to_row_binary_init());

/* 
    (fun ("[UDP Void | TCP Void]") (if (eq (u16 0) (label-of (param 0))) (size 2) (seq (assert (eq (label-of (param 0)) (u16 1))) (size 2))))
 */
static std::function<Size(::dessser::gen::raql_ip_protocol::t const &)> sersize_of_row_binary_init()
{
  std::function<Size(::dessser::gen::raql_ip_protocol::t const &)> fun12 { [&](::dessser::gen::raql_ip_protocol::t p_0) {
    uint16_t id_13 { 0 };
...
std::function<Size(::dessser::gen::raql_ip_protocol::t const &)> sersize_of_row_binary(sersize_of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> of_row_binary_init()
{
  std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> fun23 { [&](Pointer p_0) {
    ...
    ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 let_res_27;
    {
      ::dessser::gen::raql_ip_protocol::ta97bb48ed75bbda6173555873826c8c6 dsum1_63 { letpair_res_25 };
      ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 letpair_res_28;
      {
        auto dsum1_fst_64 { std::get<0>(dsum1_63) };
        auto dsum1_snd_65 { std::get<1>(dsum1_63) };
        uint16_t id_29 { 0 };
        bool id_30 { bool(id_29 == dsum1_fst_64) };
        ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 choose_res_31;
        if (id_30) {
          (void)::dessser::Void();
          ::dessser::gen::raql_ip_protocol::t id_32 { std::in_place_index<0>, ::dessser::Void() };
          ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 id_33 { id_32, dsum1_snd_65 };
          choose_res_31 = id_33;
        } else {
          uint16_t id_34 { 1 };
          ...
          (void)id_36;
          (void)::dessser::Void();
          ::dessser::gen::raql_ip_protocol::t id_37 { std::in_place_index<1>, ::dessser::Void() };
          ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 id_38 { id_37, dsum1_snd_65 };
          choose_res_31 = id_38;
        }
...
std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> fun39 { [&](Pointer p_0) {
    ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 id_40 { of_row_binary(p_0) };
    ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 letpair_res_41;
    {
      auto make_fst_73 { std::get<0>(id_40) };
      auto make_snd_74 { std::get<1>(id_40) };
      ::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48 id_42 { make_fst_73, make_snd_74 };
...
std::function<::dessser::gen::raql_ip_protocol::t79eade9ade2a11d25def1cd0e6a98e48(Pointer &)> wrap_of_row_binary(wrap_of_row_binary_init());

/* 
    (fun ("[UDP Void | TCP Void]" "Ptr") (apply (identifier "to-row-binary") (param 0) (param 1)))
 */
static std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> wrap_to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> fun43 { [&](::dessser::gen::raql_ip_protocol::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::raql_ip_protocol::t const &,Pointer &)> wrap_to_row_binary(wrap_to_row_binary_init());
