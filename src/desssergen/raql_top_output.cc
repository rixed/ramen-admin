...
{
  std::function<::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c(Pointer)> fun32 { [&fun32](Pointer p_0) {
    ...
    ::dessser::gen::raql_top_output::ta97bb48ed75bbda6173555873826c8c6 letpair_res_34;
    {
      ...
      ::dessser::gen::raql_top_output::ta97bb48ed75bbda6173555873826c8c6 id_35 { du16_fst_57, du16_snd_58 };
      letpair_res_34 = id_35;
    }
    ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c let_res_36;
    {
      ::dessser::gen::raql_top_output::ta97bb48ed75bbda6173555873826c8c6 dsum1_62 { letpair_res_34 };
      ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c letpair_res_37;
      {
        ...
        if (id_39) {
          ...
          ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c id_42 { id_41, dsum1_snd_64 };
          choose_res_40 = id_42;
        } else {
          uint16_t id_43 { 1 };
          ...
          if (id_44) {
            ...
            ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c id_47 { id_46, dsum1_snd_64 };
            choose_res_45 = id_47;
          } else {
            uint16_t id_48 { 2 };
            ...
            ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c id_52 { id_51, dsum1_snd_64 };
            choose_res_45 = id_52;
          }
...
{
  std::function<::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c(Pointer)> fun53 { [&fun53](Pointer p_0) {
    ...
    ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c letpair_res_55;
    {
      ...
      ::dessser::gen::raql_top_output::t39fed1293271e7460d2b7f31b53fc49c id_56 { make_fst_75, make_snd_76 };
...
{
  std::function<Pointer(std::shared_ptr<::dessser::gen::raql_top_output::t> ,Pointer)> fun57 { [&fun57](std::shared_ptr<::dessser::gen::raql_top_output::t>  p_0, Pointer p_1) {
