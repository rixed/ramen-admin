...
struct t3d76a0abf7e3ccb2cf9215195afc9265 : public std::tuple<
  ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330,
  Pointer
> {
  using tuple::tuple;
  t3d76a0abf7e3ccb2cf9215195afc9265(std::tuple<::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330, Pointer> p)
    : std::tuple<::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330, Pointer>(std::get<0>(p), std::get<1>(p)) {}
};
inline bool operator==(t3d76a0abf7e3ccb2cf9215195afc9265 const &a, t3d76a0abf7e3ccb2cf9215195afc9265 const &b) {
  return std::get<0>(a) == std::get<0>(b) && std::get<1>(a) == std::get<1>(b);
}
inline bool operator!=(t3d76a0abf7e3ccb2cf9215195afc9265 const &a, t3d76a0abf7e3ccb2cf9215195afc9265 const &b) {
  return !operator==(a, b);
...
static std::function<Pointer(std::shared_ptr<::dessser::gen::event_time::t> ,Pointer)> to_row_binary_init()
{
  std::function<Pointer(std::shared_ptr<::dessser::gen::event_time::t> ,Pointer)> fun0 { [&fun0](std::shared_ptr<::dessser::gen::event_time::t>  p_0, Pointer p_1) {
    ...
    Pointer let_res_4;
    {
      ...
      ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_5 { std::get<1>((*p_0)) };
      ...
      Pointer let_res_8;
      {
        ...
        uint16_t id_9 { 0 };
        ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_10 { std::get<1>((*p_0)) };
        uint16_t id_11 { uint16_t(id_10.index()) };
        bool id_12 { bool(id_9 == id_11) };
        Pointer choose_res_13;
        if (id_12) {
          ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_14 { std::get<1>((*p_0)) };
          ...
          uint16_t id_18 { 1 };
          ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_19 { std::get<1>((*p_0)) };
          ...
          if (id_21) {
            ...
            ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_24 { std::get<1>((*p_0)) };
            dessser::gen::event_time_field::t_ext id_25 { std::get<1 /* DurationField */>(id_24) };
            Pointer id_26 { fun23(id_25, ssum_dst_91) };
            choose_res_22 = id_26;
          } else {
            ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_27 { std::get<1>((*p_0)) };
            ...
            ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_33 { std::get<1>((*p_0)) };
...
static std::function<Size(std::shared_ptr<::dessser::gen::event_time::t> )> sersize_of_row_binary_init()
{
  std::function<Size(std::shared_ptr<::dessser::gen::event_time::t> )> fun36 { [&fun36](std::shared_ptr<::dessser::gen::event_time::t>  p_0) {
    ...
    Size let_res_40;
    {
      Size sz_87 { id_39 };
      uint16_t id_41 { 0 };
      ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_42 { std::get<1>((*p_0)) };
      ...
      if (id_44) {
        ...
        uint16_t id_50 { 1 };
        ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_51 { std::get<1>((*p_0)) };
        ...
        if (id_53) {
          ...
          ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_58 { std::get<1>((*p_0)) };
          dessser::gen::event_time_field::t_ext id_59 { std::get<1 /* DurationField */>(id_58) };
          Size id_60 { fun57(id_59) };
          Size id_61 { Size(id_56 + id_60) };
          choose_res_54 = id_61;
        } else {
          ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_62 { std::get<1>((*p_0)) };
          ...
          ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_70 { std::get<1>((*p_0)) };
  ...
  std::function<::dessser::gen::event_time::tc5af49eea21f544f0c497da6c5af45dd(Pointer)> fun74 { [&fun74](Pointer p_0) {
    ...
    ::dessser::gen::event_time::tc5af49eea21f544f0c497da6c5af45dd let_res_77;
    {
      ...
      ::dessser::gen::event_time::tc5af49eea21f544f0c497da6c5af45dd letpair_res_78;
      {
        ...
        ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 let_res_82;
        {
          ::dessser::gen::event_time::ta97bb48ed75bbda6173555873826c8c6 dsum1_65 { letpair_res_80 };
          ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 letpair_res_83;
          {
            auto dsum1_fst_66 { std::get<0>(dsum1_65) };
            auto dsum1_snd_67 { std::get<1>(dsum1_65) };
            uint16_t id_84 { 0 };
            bool id_85 { bool(id_84 == dsum1_fst_66) };
            ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 choose_res_86;
            if (id_85) {
              ::dessser::gen::event_time::td2cd337bb3c8bc04d5603393d084985b id_87 { dsum1_snd_67.readU64Le() };
              ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 letpair_res_88;
              {
                auto dfloat_fst_75 { std::get<0>(id_87) };
                auto dfloat_snd_76 { std::get<1>(id_87) };
                double id_89 { float_of_qword(dfloat_fst_75) };
                ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_90 { std::in_place_index<0>, id_89 };
                ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 id_91 { id_90, dfloat_snd_76 };
              ...
              ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 choose_res_94;
              if (id_93) {
                ...
                ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 letpair_res_97;
                {
                  auto dsum2_fst_72 { std::get<0>(id_96) };
                  auto dsum2_snd_73 { std::get<1>(id_96) };
                  ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_98 { std::in_place_index<1>, dsum2_fst_72 };
                  ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 id_99 { id_98, dsum2_snd_73 };
                ...
                ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 letpair_res_105;
                {
                  auto dsum2_fst_69 { std::get<0>(id_104) };
                  auto dsum2_snd_70 { std::get<1>(id_104) };
                  ::dessser::gen::event_time::te56444ea7a5883cbac09e8c474932330 id_106 { std::in_place_index<2>, dsum2_fst_69 };
                  ::dessser::gen::event_time::t3d76a0abf7e3ccb2cf9215195afc9265 id_107 { id_106, dsum2_snd_70 };
