...
inline std::ostream &operator<<(std::ostream &os, t9f25ed50c831f0d73db2f922456ab51a const &t) {
  os << '<';
  os << std::get<0>(t) << ", ";
  os << std::get<1>(t);
  os << '>';
...
inline std::ostream &operator<<(std::ostream &os, std::shared_ptr<t9f25ed50c831f0d73db2f922456ab51a> const t) { os << *t; return os; }
