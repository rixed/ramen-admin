...
{
  std::function<Pointer(::dessser::gen::fq_function_name::t &,Pointer &)> fun0 { [&](::dessser::gen::fq_function_name::t p_0, Pointer p_1) {
...
{
  std::function<Size(::dessser::gen::fq_function_name::t &)> fun12 { [&](::dessser::gen::fq_function_name::t p_0) {
 ...
 */
static std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> of_row_binary_init()
{
  std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> fun26 { [&](Pointer p_0) {
    ...
    ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b let_res_29;
    {
      ::dessser::gen::fq_function_name::t5fda3fa18a9129079240e343cc4c7827 drec_57 { id_28 };
      ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b letpair_res_30;
      {
        ...
        ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b let_res_33;
        {
          ::dessser::gen::fq_function_name::td8645decacfa82d2239ee8ec2f67634c drec_60 { id_32 };
          ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b letpair_res_34;
          {
            ...
            ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b letpair_res_37;
            {
              auto drec_fst_64 { std::get<0>(id_36) };
              auto drec_snd_65 { std::get<1>(id_36) };
              ::dessser::gen::fq_function_name::t id_38 { drec_fst_58, drec_fst_61, drec_fst_64 };
              ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b id_39 { id_38, drec_snd_65 };
...
std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> fun40 { [&](Pointer p_0) {
    ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b id_41 { of_row_binary(p_0) };
    ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b letpair_res_42;
    {
      auto make_fst_67 { std::get<0>(id_41) };
      auto make_snd_68 { std::get<1>(id_41) };
      ::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b id_43 { make_fst_67, make_snd_68 };
...
std::function<::dessser::gen::fq_function_name::t4b558bb1cde3ecfada103f106c8a606b(Pointer &)> wrap_of_row_binary(wrap_of_row_binary_init());

/* 
    (fun ("{site: $site_name; program: $program_name; function: $function_name}" "Ptr") (apply (identifier "to-row-binary") (param 0) (param 1)))
 */
static std::function<Pointer(::dessser::gen::fq_function_name::t &,Pointer &)> wrap_to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::fq_function_name::t &,Pointer &)> fun44 { [&](::dessser::gen::fq_function_name::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::fq_function_name::t &,Pointer &)> wrap_to_row_binary(wrap_to_row_binary_init());
