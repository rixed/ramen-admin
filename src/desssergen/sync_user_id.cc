 ...
 */
static std::function<::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0(Pointer)> of_row_binary_init()
{
  std::function<::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0(Pointer)> fun66 { [&fun66](Pointer p_0) {
    uint32_t id_67 { 0U };
    Vec<1, uint32_t> id_68 {  id_67  };
    ::dessser::gen::sync_user_id::t8beb80162423aee37bd383e9b6834c9c let_res_69;
    {
      Vec<1, uint32_t> leb_ref_56 { id_68 };
      uint8_t id_70 { 0 };
      Vec<1, uint8_t> id_71 {  id_70  };
      ::dessser::gen::sync_user_id::t8beb80162423aee37bd383e9b6834c9c let_res_72;
      {
        Vec<1, uint8_t> shft_ref_57 { id_71 };
        Vec<1, Pointer> id_73 {  p_0  };
        ::dessser::gen::sync_user_id::t8beb80162423aee37bd383e9b6834c9c let_res_74;
        {
          ...
          do {
            ...
            ::dessser::gen::sync_user_id::tb3f98ea670610d40658a618de3ec7b90 id_78 { id_77.readU8() };
            bool let_res_79;
            {
              ::dessser::gen::sync_user_id::tb3f98ea670610d40658a618de3ec7b90 leb128_59 { id_78 };
              bool letpair_res_80;
              {
          ...
          ::dessser::gen::sync_user_id::t8beb80162423aee37bd383e9b6834c9c id_107 { id_104, id_106 };
          let_res_74 = id_107;
        }
    ...
    ::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0 let_res_108;
    {
      ::dessser::gen::sync_user_id::t8beb80162423aee37bd383e9b6834c9c dstring1_62 { let_res_69 };
      ::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0 letpair_res_109;
      {
        auto dstring1_fst_63 { std::get<0>(dstring1_62) };
        auto dstring1_snd_64 { std::get<1>(dstring1_62) };
        ::dessser::gen::sync_user_id::t188345aa49abd0cb47ff73fedc219f08 id_110 { dstring1_snd_64.readBytes(dstring1_fst_63) };
        ::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0 letpair_res_111;
        {
          auto dstring2_fst_66 { std::get<0>(id_110) };
          auto dstring2_snd_67 { std::get<1>(id_110) };
          t id_112 { dstring2_fst_66.toString() };
          ::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0 id_113 { id_112, dstring2_snd_67 };
...
std::function<::dessser::gen::sync_user_id::t519c57b31160411c6989716f3a9782e0(Pointer)> of_row_binary(of_row_binary_init());
