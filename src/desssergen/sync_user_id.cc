 ...
 */
static std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> of_row_binary_init()
{
  std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> fun66 { [&](Pointer p_0) {
    uint32_t id_67 { 0U };
    Vec<1, uint32_t> id_68 {  id_67  };
    ::dessser::gen::sync_user_id::t12fb9c475959b52bf7b17b155a955ffa let_res_69;
    {
      Vec<1, uint32_t> leb_ref_57 { id_68 };
      uint8_t id_70 { 0 };
      Vec<1, uint8_t> id_71 {  id_70  };
      ::dessser::gen::sync_user_id::t12fb9c475959b52bf7b17b155a955ffa let_res_72;
      {
        Vec<1, uint8_t> shft_ref_58 { id_71 };
        Vec<1, Pointer> id_73 {  p_0  };
        ::dessser::gen::sync_user_id::t12fb9c475959b52bf7b17b155a955ffa let_res_74;
        {
          ...
          do {
            ...
            ::dessser::gen::sync_user_id::t1a5d74abf838df33f185a72a8912f5c9 id_78 { id_77.readU8() };
            bool let_res_79;
            {
              ::dessser::gen::sync_user_id::t1a5d74abf838df33f185a72a8912f5c9 leb128_60 { id_78 };
              bool letpair_res_80;
              {
          ...
          ::dessser::gen::sync_user_id::t12fb9c475959b52bf7b17b155a955ffa id_107 { id_104, id_106 };
          let_res_74 = id_107;
        }
    ...
    ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 let_res_108;
    {
      ::dessser::gen::sync_user_id::t12fb9c475959b52bf7b17b155a955ffa dstring1_63 { let_res_69 };
      ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 letpair_res_109;
      {
        auto dstring1_fst_64 { std::get<0>(dstring1_63) };
        auto dstring1_snd_65 { std::get<1>(dstring1_63) };
        ::dessser::gen::sync_user_id::t9ef6882174ae71a34a3c5ef6b29242fb id_110 { dstring1_snd_65.readBytes(dstring1_fst_64) };
        ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 letpair_res_111;
        {
          auto dstring2_fst_67 { std::get<0>(id_110) };
          auto dstring2_snd_68 { std::get<1>(id_110) };
          t id_112 { dstring2_fst_67.toString() };
          ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 id_113 { id_112, dstring2_snd_68 };
...
std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> fun114 { [&](Pointer p_0) {
    ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 id_115 { of_row_binary(p_0) };
    ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 letpair_res_116;
    {
      auto make_fst_70 { std::get<0>(id_115) };
      auto make_snd_71 { std::get<1>(id_115) };
      ::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016 id_117 { make_fst_70, make_snd_71 };
...
std::function<::dessser::gen::sync_user_id::ta30293a82943182cab78182f33b18016(Pointer &)> wrap_of_row_binary(wrap_of_row_binary_init());
