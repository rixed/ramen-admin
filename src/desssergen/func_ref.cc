...
{
  std::function<Pointer(::dessser::gen::func_ref::t &,Pointer &)> fun0 { [&](::dessser::gen::func_ref::t p_0, Pointer p_1) {
...
{
  std::function<Size(::dessser::gen::func_ref::t &)> fun12 { [&](::dessser::gen::func_ref::t p_0) {
 ...
 */
static std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> of_row_binary_init()
{
  std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> fun26 { [&](Pointer p_0) {
    auto fun27 { dessser::gen::site_name::of_row_binary };
    ::dessser::gen::func_ref::t5fda3fa18a9129079240e343cc4c7827 id_28 { fun27(p_0) };
    ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b let_res_29;
    {
      ::dessser::gen::func_ref::t5fda3fa18a9129079240e343cc4c7827 drec_57 { id_28 };
      ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b letpair_res_30;
      {
        ...
        ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b let_res_33;
        {
          ::dessser::gen::func_ref::td8645decacfa82d2239ee8ec2f67634c drec_60 { id_32 };
          ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b letpair_res_34;
          {
            ...
            ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b letpair_res_37;
            {
              auto drec_fst_64 { std::get<0>(id_36) };
              auto drec_snd_65 { std::get<1>(id_36) };
              ::dessser::gen::func_ref::t id_38 { drec_fst_58, drec_fst_61, drec_fst_64 };
              ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b id_39 { id_38, drec_snd_65 };
...
std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> fun40 { [&](Pointer p_0) {
    ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b id_41 { of_row_binary(p_0) };
    ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b letpair_res_42;
    {
      auto make_fst_67 { std::get<0>(id_41) };
      auto make_snd_68 { std::get<1>(id_41) };
      ::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b id_43 { make_fst_67, make_snd_68 };
...
std::function<::dessser::gen::func_ref::tfb5850dc2ea05a09c67b0800d7db1b4b(Pointer &)> wrap_of_row_binary(wrap_of_row_binary_init());

/* 
    (fun ("{site: $site_name; program: $program_name; func: $function_name}" "Ptr") (apply (identifier "to-row-binary") (param 0) (param 1)))
 */
static std::function<Pointer(::dessser::gen::func_ref::t &,Pointer &)> wrap_to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::func_ref::t &,Pointer &)> fun44 { [&](::dessser::gen::func_ref::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::func_ref::t &,Pointer &)> wrap_to_row_binary(wrap_to_row_binary_init());
