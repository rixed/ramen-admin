 ...
 */
static std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> fun0 { [&](::dessser::gen::raql_error::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> to_row_binary(to_row_binary_init());
 ...
 */
static std::function<Size(::dessser::gen::raql_error::t const &)> sersize_of_row_binary_init()
{
  std::function<Size(::dessser::gen::raql_error::t const &)> fun63 { [&](::dessser::gen::raql_error::t p_0) {
...
std::function<Size(::dessser::gen::raql_error::t const &)> sersize_of_row_binary(sersize_of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> of_row_binary_init()
{
  std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> fun112 { [&](Pointer p_0) {
    Size id_113 { 0UL };
    ...
    ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 let_res_128;
    {
      ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 drec_63 { choose_res_117 };
      ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 letpair_res_129;
      {
        ...
        ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 let_res_145;
        {
          ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 drec_72 { choose_res_134 };
          ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 letpair_res_146;
          {
            ...
            ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 let_res_188;
            {
              ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa dstring1_81 { let_res_149 };
              ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 letpair_res_189;
              {
                ...
                ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 letpair_res_191;
                {
                  auto dstring2_fst_85 { std::get<0>(id_190) };
                  auto dstring2_snd_86 { std::get<1>(id_190) };
                  std::string id_192 { dstring2_fst_85.toString() };
                  ::dessser::gen::raql_error::t id_193 { drec_fst_64, drec_fst_73, id_192 };
                  ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 id_194 { id_193, dstring2_snd_86 };
...
std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> fun195 { [&](Pointer p_0) {
    ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 id_196 { of_row_binary(p_0) };
    ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 letpair_res_197;
    {
      auto make_fst_91 { std::get<0>(id_196) };
      auto make_snd_92 { std::get<1>(id_196) };
      ::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02 id_198 { make_fst_91, make_snd_92 };
...
std::function<::dessser::gen::raql_error::t1cab2bd00a56ef54fd99311e24924b02(Pointer &)> wrap_of_row_binary(wrap_of_row_binary_init());

/* 
    (fun ("{line: U32?; column: U32?; message: STRING}" "Ptr") (apply (identifier "to-row-binary") (param 0) (param 1)))
 */
static std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> wrap_to_row_binary_init()
{
  std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> fun199 { [&](::dessser::gen::raql_error::t p_0, Pointer p_1) {
...
std::function<Pointer(::dessser::gen::raql_error::t const &,Pointer &)> wrap_to_row_binary(wrap_to_row_binary_init());
