 ...
 */
static std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> to_row_binary_init()
{
  std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> fun0 { [&](std::shared_ptr<::dessser::gen::raql_error::t>  p_0, Pointer p_1) {
...
std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> to_row_binary(to_row_binary_init());
 ...
 */
static std::function<Size(std::shared_ptr<::dessser::gen::raql_error::t> )> sersize_of_row_binary_init()
{
  std::function<Size(std::shared_ptr<::dessser::gen::raql_error::t> )> fun63 { [&](std::shared_ptr<::dessser::gen::raql_error::t>  p_0) {
...
std::function<Size(std::shared_ptr<::dessser::gen::raql_error::t> )> sersize_of_row_binary(sersize_of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> of_row_binary_init()
{
  std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> fun112 { [&](Pointer p_0) {
    Size id_113 { 0UL };
    uint8_t id_114 { p_0.peekU8(id_113) };
    uint8_t id_115 { 1 };
    bool id_116 { bool(id_114 == id_115) };
    ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 choose_res_117;
    if (id_116) {
      std::optional<uint32_t> id_118 { std::nullopt };
      Size id_119 { 1UL };
      Pointer id_120 { p_0.skip(id_119) };
      ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 id_121 { id_118, id_120 };
      choose_res_117 = id_121;
    } else {
      Size id_122 { 1UL };
      Pointer id_123 { p_0.skip(id_122) };
      ::dessser::gen::raql_error::t491c44439106a32f896827242e8e76a1 id_124 { id_123.readU32Le() };
      ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 letpair_res_125;
      {
        auto du32_fst_58 { std::get<0>(id_124) };
        auto du32_snd_59 { std::get<1>(id_124) };
        std::optional<uint32_t> id_126 { du32_fst_58 };
        ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 id_127 { id_126, du32_snd_59 };
        letpair_res_125 = id_127;
      }
      choose_res_117 = letpair_res_125;
    }
    ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c let_res_128;
    {
      ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 drec_63 { choose_res_117 };
      ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c letpair_res_129;
      {
        ...
        ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 choose_res_134;
        if (id_133) {
          std::optional<uint32_t> id_135 { std::nullopt };
          Size id_136 { 1UL };
          Pointer id_137 { drec_snd_65.skip(id_136) };
          ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 id_138 { id_135, id_137 };
          choose_res_134 = id_138;
        } else {
          Size id_139 { 1UL };
          Pointer id_140 { drec_snd_65.skip(id_139) };
          ::dessser::gen::raql_error::t491c44439106a32f896827242e8e76a1 id_141 { id_140.readU32Le() };
          ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 letpair_res_142;
          {
            auto du32_fst_67 { std::get<0>(id_141) };
            auto du32_snd_68 { std::get<1>(id_141) };
            std::optional<uint32_t> id_143 { du32_fst_67 };
            ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 id_144 { id_143, du32_snd_68 };
            letpair_res_142 = id_144;
          }
          choose_res_134 = letpair_res_142;
        }
        ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c let_res_145;
        {
          ::dessser::gen::raql_error::t112740284841ba75ec1e9fc60758e609 drec_72 { choose_res_134 };
          ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c letpair_res_146;
          {
            auto drec_fst_73 { std::get<0>(drec_72) };
            auto drec_snd_74 { std::get<1>(drec_72) };
            uint32_t id_147 { 0U };
            Vec<1, uint32_t> id_148 {  id_147  };
            ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa let_res_149;
            {
              Vec<1, uint32_t> leb_ref_75 { id_148 };
              uint8_t id_150 { 0 };
              Vec<1, uint8_t> id_151 {  id_150  };
              ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa let_res_152;
              {
                Vec<1, uint8_t> shft_ref_76 { id_151 };
                Vec<1, Pointer> id_153 {  drec_snd_74  };
                ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa let_res_154;
                {
                  ...
                  do {
                    ...
                    ::dessser::gen::raql_error::t1a5d74abf838df33f185a72a8912f5c9 id_158 { id_157.readU8() };
                    bool let_res_159;
                    {
                      ::dessser::gen::raql_error::t1a5d74abf838df33f185a72a8912f5c9 leb128_78 { id_158 };
                  ...
                  ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa id_187 { id_184, id_186 };
                  let_res_154 = id_187;
                }
            ...
            ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c let_res_188;
            {
              ::dessser::gen::raql_error::t12fb9c475959b52bf7b17b155a955ffa dstring1_81 { let_res_149 };
              ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c letpair_res_189;
              {
                auto dstring1_fst_82 { std::get<0>(dstring1_81) };
                auto dstring1_snd_83 { std::get<1>(dstring1_81) };
                ::dessser::gen::raql_error::t9ef6882174ae71a34a3c5ef6b29242fb id_190 { dstring1_snd_83.readBytes(dstring1_fst_82) };
                ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c letpair_res_191;
                {
                  auto dstring2_fst_85 { std::get<0>(id_190) };
                  auto dstring2_snd_86 { std::get<1>(id_190) };
                  std::string id_192 { dstring2_fst_85.toString() };
                  std::shared_ptr<::dessser::gen::raql_error::t>  id_193 { std::make_shared<::dessser::gen::raql_error::t>(drec_fst_64, drec_fst_73, id_192) };
                  ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c id_194 { id_193, dstring2_snd_86 };
...
std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> of_row_binary(of_row_binary_init());
 ...
 */
static std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> wrap_of_row_binary_init()
{
  std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> fun195 { [&](Pointer p_0) {
    ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c id_196 { of_row_binary(p_0) };
    ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c letpair_res_197;
    {
      auto make_fst_91 { std::get<0>(id_196) };
      auto make_snd_92 { std::get<1>(id_196) };
      ::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c id_198 { make_fst_91, make_snd_92 };
...
std::function<::dessser::gen::raql_error::tc4decde8a76b3f0176e2fbbfd596fe9c(Pointer)> wrap_of_row_binary(wrap_of_row_binary_init());

/* 
    (fun ("{line: U32?; column: U32?; message: STRING}" "Ptr") (apply (identifier "to-row-binary") (param 0) (param 1)))
 */
static std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> wrap_to_row_binary_init()
{
  std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> fun199 { [&](std::shared_ptr<::dessser::gen::raql_error::t>  p_0, Pointer p_1) {
...
std::function<Pointer(std::shared_ptr<::dessser::gen::raql_error::t> ,Pointer)> wrap_to_row_binary(wrap_to_row_binary_init());
