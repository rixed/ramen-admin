#ifndef DESSSER_GEN_team_name
#define DESSSER_GEN_team_name
#include <functional>
#include <memory>
#include <optional>
#include <tuple>
...
extern std::function<::dessser::gen::team_name::ta30293a82943182cab78182f33b18016(Pointer)> of_row_binary;
extern std::function<::dessser::gen::team_name::ta30293a82943182cab78182f33b18016(Pointer)> wrap_of_row_binary;
