...
KVecEditor::KVecEditor(unsigned dim, dessser::gen::raql_type::t const &typ,
                       QWidget *parent)
    : AtomicWidget(parent) {
...
std::shared_ptr<dessser::gen::sync_value::t const> KVecEditor::getValue()
    const {
