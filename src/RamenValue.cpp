...
AtomicWidget *RamenValue::editorWidget(std::string const &key,
...
QString const VFloat::toQString(std::string const &key) const {
  if (key == "time" || endsWith(key, "/last_exit") ||
      endsWith(key, "/last_killed") || endsWith(key, "/quarantine_until") ||
      endsWith(key, "/first_attempt") || endsWith(key, "/last_attempt") ||
      endsWith(key, "/next_scheduled") || endsWith(key, "/next_send"))
    return stringOfDate(v);
  else
    return QString::number(v, 'g', 13);
}

AtomicWidget *VFloat::editorWidget(std::string const &key,
                                   QWidget *parent) const {
  KFloatEditor *editor = key == "storage/recall_cost"
...
AtomicWidget *VString::editorWidget(std::string const &key,
                                    QWidget *parent) const {
  AtomicWidget *editor =
...
AtomicWidget *VBool::editorWidget(std::string const &key,
                                  QWidget *parent) const {
...
AtomicWidget *VChar::editorWidget(std::string const &key,
                                  QWidget *parent) const {
  KCharEditor *editor = new KCharEditor(&VChar::ofQString, parent);
  editor->setKey(key);
  return editor;
}
...
AtomicWidget *VU8::editorWidget(std::string const &key, QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU8::ofQString, parent, 0,
...
AtomicWidget *VU16::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU16::ofQString, parent, 0,
...
AtomicWidget *VU24::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU24::ofQString, parent, 0, 16777216ULL);
  editor->setKey(key);
  return editor;
}
...
AtomicWidget *VU32::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU32::ofQString, parent, 0,
...
AtomicWidget *VU40::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor =
...
AtomicWidget *VU48::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor =
...
AtomicWidget *VU56::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor =
...
AtomicWidget *VU64::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU64::ofQString, parent, 0,
...
QString const VU128::toQString(std::string const &) const {
  ...
  std::snprintf(s, sizeof(s), "%016" PRIx64 "%016" PRIx64, (uint64_t)(v >> 64),
                (uint64_t)v);
  return QString(s);
}
...
AtomicWidget *VU128::editorWidget(std::string const &key,
                                  QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VU128::ofQString, parent, 0,
...
AtomicWidget *VI8::editorWidget(std::string const &key, QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI8::ofQString, parent,
...
AtomicWidget *VI16::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI16::ofQString, parent,
...
AtomicWidget *VI24::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor =
...
AtomicWidget *VI32::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI32::ofQString, parent,
...
AtomicWidget *VI40::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor =
...
AtomicWidget *VI48::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI48::ofQString, parent,
...
AtomicWidget *VI56::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(
      &VI56::ofQString, parent, -36028797018963968LL, 36028797018963967LL);
  editor->setKey(key);
  return editor;
}
...
AtomicWidget *VI64::editorWidget(std::string const &key,
                                 QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI64::ofQString, parent,
...
QString const VI128::toQString(std::string const &) const {
  ...
  std::snprintf(s + 1, sizeof(s) - 1, "%016" PRIx64 "%016" PRIx64,
                (uint64_t)(v_ >> 64), (uint64_t)v_);
...
AtomicWidget *VI128::editorWidget(std::string const &key,
                                  QWidget *parent) const {
  KIntEditor *editor = new KIntEditor(&VI128::ofQString, parent,
...
VTuple::VTuple(value v_) {
  ...
  v.reserve(numFields);
  for (unsigned i = 0; i < numFields; i++) append(ofOCaml(Field(v_, i)));
  CAMLreturn0;
}
